...
origins = [
    "http://localhost:3000",    # Your frontend (exposed by docker-compose, likely on host port 3000)
    "http://127.0.0.1:3000",  # Alias for localhost
    "http://localhost:5173",    # If Vite dev server runs on this AND you access it directly
    "http://127.0.0.1:5173",  # Alias for localhost
    # "http://localhost:8081", # Add if you use this specific port for frontend
    # Remove "http://localhost:8000" from origins - the backend doesn't make CORS requests to itself.
]
